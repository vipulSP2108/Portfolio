...
export default function Cursor() {
    ...
    return (
        <div className=' z-50 top-0 left-0 pointer-events-none'>
            <div ref={cursorDot} style={{ position: 'fixed' }} className='fixed z-50 h-4 w-4 bg-black rounded-full top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]' />
